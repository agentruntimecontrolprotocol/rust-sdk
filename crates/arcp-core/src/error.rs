...
pub enum ARCPError {
    ...
    /// Persistent storage failure (event log, artifact store). Carries a
    /// stringified description of the underlying driver error so this crate
    /// stays free of storage-backend dependencies.
